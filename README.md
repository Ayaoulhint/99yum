...
Simple authentication (sign up, login)

Add & edit recipes and blog posts for logged-in users

Upload images to make your dishes shine
...
🔥 @vitejs/plugin-react & plugin-react-swc — for smooth React refresh

☁️ Appwrite — open-source backend-as-a-service for auth, DB & storage
